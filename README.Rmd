...
The **qsip** package supports stable isotope experiments using ^18^O, ^13^C, and ^15^N. It is also agnostic towards the amplicon being sequenced. It will support 16S, 18S, ITS, or other amplicon sequencing data.
